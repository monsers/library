					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									<tr>
										<td><img src="{{asset('/')}}hotai/ico/flags/Germany.png" style="height:18px; margin-top:-2px;"></td>
										<td>Germany</td>
										<td>2563</td>
										<td>1025</td>
										<td>
									...
									<tr>
										<td><img src="{{asset('/')}}hotai/ico/flags/India.png" style="height:18px; margin-top:-2px;"></td>
										<td>India</td>
										<td>3652</td>
										<td>2563</td>
										<td>
									...
									<tr>
										<td><img src="{{asset('/')}}hotai/ico/flags/Spain.png" style="height:18px; margin-top:-2px;"></td>
										<td>Spain</td>
										<td>562</td>
										<td>452</td>
										<td>
									...
									<tr>
										<td><img src="{{asset('/')}}hotai/ico/flags/Russia.png" style="height:18px; margin-top:-2px;"></td>
										<td>Russia</td>
										<td>1258</td>
										<td>958</td>
										<td>
									...
									<tr>
										<td><img src="{{asset('/')}}hotai/ico/flags/usa.png" style="height:18px; margin-top:-2px;"></td>
										<td>USA</td>
										<td>4856</td>
										<td>3621</td>
										<td>
									...
									<tr>
										<td><img src="{{asset('/')}}hotai/ico/flags/brazil.png" style="height:18px; margin-top:-2px;"></td>
										<td>Brazil</td>
										<td>265</td>
										<td>102</td>
										<td>
